...
# Helpers path
set ( CMAKE_HELPERS_PATH ${HELPERS_PATH} CACHE PATH "Full path to helpers." )
...
# Combined libraries
get_filename_component ( _combined  "${CMAKE_HELPERS_PATH}/../combined" REALPATH )
set ( COMBINED_ROOT_DIR ${_combined} CACHE PATH "Path to combined libraries.")
set ( COMBINED_LIB_PATH "${_combined}/lib/" CACHE PATH "Combined libs.")
set ( COMBINED_INCLUDE_PATH "${_combined}/include/" CACHE PATH "Combined includes.")
...
message ( "CMAKE_HELPERS_PATH: ${CMAKE_HELPERS_PATH}" )
